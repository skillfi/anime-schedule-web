...
/** Track Timeline Interface
 * @property {String} id - Timeline id
 * @property {string} title - Timeline title
 * @property {Date} start - start date
 * @property {Date} end - End Date
 * @property {CSSProperties} style - HTML Style
 * @property {number} i - ?
 */
export interface TracTimeline{
    id: string;
    title: string;
    start: Date;
    end: Date;
...
interface ISubTrack{
    id: string;
    title: string;
    elements: TracTimeline[]
}

/** ITrack Interface
 * @property {string} id - track id
 * @property {string} title - track title
 * @property {Array<TracTimeline>} elements - Subtracks
 * @property {boolean} isOpen - Open Track
 */
...
export interface EpisodeTimeLine extends Episode{
    anime: IAnime
}
