...
import {AlertColor, Box, BoxProps, Tab} from "@mui/material";
            ...
            >
                ...
                <ThemeProvider theme={adminTabsTheme}>
                    <StyledTabs
                        ...
                        variant="scrollable"
                        sx = {{
                            width: Tools.getWindowDimension().minWidth * 0.9
                        }}
                        // centered={true}
                    >
                ...
                {this.props.bookmarks.map((name, index) =>
                    <AdministrationTabPanelComponent index={index} value={this.state.value} key={index}>
                        <TableComponent list_name={name} key={index} type={this.props.type}
